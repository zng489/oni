...
file = {'namespace':'/oni',
        'file_folder':'/rfb/tributacao/renuncias_fiscais_cnpj/dirbi_dicionario_de_dados_de_renuncia_fiscal_por_regime_especial_de_tributação/',
        'file_subfolder':'', 
        'sheet_name':'',         
        'raw_path':'/usr/oni/rfb/tributacao/renuncias_fiscais_cnpj/dirbi_dic_ren_fisc_reg_esp_trib/',         
        'prm_path': '',          
...
# df = (
#    cf.append_control_columns(df, dh_insercao_raw=adf["adf_trigger_time"])
#      .withColumn("dh_insercao_raw_exec", lit(dh_insercao_raw).cast("timestamp"))
#)
