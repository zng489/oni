...
tables =  {"schema":"",
           "table":"",
           "prm_path":"",
           "raw_path":"/crw/oni/obrasgov/cipi/intervencao/org_raw_obrasgov_cipi_intervencao/",
           "trs_path":"/oni/obrasgov/cipi/intervencao/raw_trs_obrasgov_cipi_intervencao/"}
...
col_rename_map = {
    ...
    "POSSUI_FOTO": "IN_FOTO",
    "PROJETO_ESTRUTURANTE": "NM_PROJ_ESTRUT",
    "UF_LOCALIZACAO": "SG_UF_LOC",
    "NOME__APELIDO_": "NM_APELIDO",
    "OBJETO": "DS_OBJETO",
    "FUNCAO_SOCIAL": "NM_FUNCAO_SOCIAL",
    "TIPO_NATUREZA_DA_INTERVENCAO": "TP_INTERV",
    "ESPECIE": "TP_ESPECIE",
    "INVESTIMENTO_PREVISTO": "VL_INV_PREV",
    "EXECUTOR_DA_OBRA": "NM_EXECUTOR",
    "DATA_INICIAL_PREVISTA": "DT_INI_PREV",
    "DATA_FINAL_PREVISTA": "DT_FIM_PREV",
    "SITUACAO_DA_INTERVENCAO": "DS_SIT_INTERV",
    "SISTEMA": "NM_SISTEMA",
    "EMPREGOS_GERADOS": "QT_EMP_GERADOS",
    "DATA_DE_CADASTRO": "DT_CADASTRO",
    "LOCALIZACAO_COORDENADAS": "DS_COORDENADAS"
}
...
df = tcf.add_control_fields(df, adf).select(
...
(df.repartition(8)  # ou repartition("id_cliente") para balancear por chave
  .write
  .mode("overwrite")
