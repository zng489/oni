...
tables = {'schema':'oni/mgi_obrasgov_cpi',
 'table':'intervencao/',
 'prm_path':'',
...
prm_path = os.path.join(prm, tables["prm_path"])
lnd_path = f'{lnd}/crw/{tables["schema"]}__{tables["table"]}'
print(lnd_path)
...
raw_crw_path = f"{raw}{tables['raw_path']}"
print(raw_crw_path)
